...
const LOCAL_OVERLAY_FILES = [
  ...
  'overlays/shape-circle-fill.svg',
  'overlays/shape-circle-outline.svg',
  'overlays/shape-ellipse-fill.svg',
  'overlays/shape-ellipse-outline.svg',
  ...
  'overlays/shape-rect-fill.svg',
  'overlays/shape-rect-outline.svg',
  'overlays/shape-rounded-rect-fill.svg',
  'overlays/shape-rounded-rect-outline.svg',
  'overlays/shape-square-fill.svg',
  'overlays/shape-square-outline.svg',
