...
$specialArrows = @(
  [pscustomobject]@{ Name = 'arrow-curve-right'; Path = "<path d='M76 352c0-112 86-188 210-188h134' fill='none' stroke='#111' stroke-width='24' stroke-linecap='round'/><path d='M334 94 448 164 334 234Z' fill='#fff' stroke='#111' stroke-width='18' stroke-linejoin='round'/>" },
  [pscustomobject]@{ Name = 'arrow-curve-left'; Path = "<path d='M436 352c0-112-86-188-210-188H92' fill='none' stroke='#111' stroke-width='24' stroke-linecap='round'/><path d='M178 94 64 164l114 70Z' fill='#fff' stroke='#111' stroke-width='18' stroke-linejoin='round'/>" },
  [pscustomobject]@{ Name = 'arrow-uturn-right'; Path = "<path d='M124 86v154c0 82 60 146 146 146h154' fill='none' stroke='#111' stroke-width='24' stroke-linecap='round'/><path d='M334 316 448 386 334 456Z' fill='#fff' stroke='#111' stroke-width='18' stroke-linejoin='round'/>" },
  [pscustomobject]@{ Name = 'arrow-uturn-left'; Path = "<path d='M388 86v154c0 82-60 146-146 146H88' fill='none' stroke='#111' stroke-width='24' stroke-linecap='round'/><path d='M178 316 64 386l114 70Z' fill='#fff' stroke='#111' stroke-width='18' stroke-linejoin='round'/>" },
  ...
  [pscustomobject]@{ Name = 'arrow-split-right'; Path = "<path d='M64 256h176' fill='none' stroke='#111' stroke-width='22' stroke-linecap='round'/><path d='M240 256C300 256 338 224 396 176' fill='none' stroke='#111' stroke-width='20' stroke-linecap='round'/><path d='M240 256C300 256 338 288 396 336' fill='none' stroke='#111' stroke-width='20' stroke-linecap='round'/><path d='M328 132 448 176 328 220Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/><path d='M328 292 448 336 328 380Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/>" },
  [pscustomobject]@{ Name = 'arrow-split-left'; Path = "<g transform='rotate(180 256 256)'><path d='M64 256h176' fill='none' stroke='#111' stroke-width='22' stroke-linecap='round'/><path d='M240 256C300 256 338 224 396 176' fill='none' stroke='#111' stroke-width='20' stroke-linecap='round'/><path d='M240 256C300 256 338 288 396 336' fill='none' stroke='#111' stroke-width='20' stroke-linecap='round'/><path d='M328 132 448 176 328 220Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/><path d='M328 292 448 336 328 380Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/></g>" },
  [pscustomobject]@{ Name = 'arrow-zigzag-right'; Path = "<path d='M64 320 144 224 224 320 304 224 384 320 432 256' fill='none' stroke='#111' stroke-width='22' stroke-linecap='round' stroke-linejoin='round'/><path d='M344 194 448 256 344 318Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/>" },
  [pscustomobject]@{ Name = 'arrow-zigzag-left'; Path = "<g transform='rotate(180 256 256)'><path d='M64 320 144 224 224 320 304 224 384 320 432 256' fill='none' stroke='#111' stroke-width='22' stroke-linecap='round' stroke-linejoin='round'/><path d='M344 194 448 256 344 318Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/></g>" },
  [pscustomobject]@{ Name = 'arrow-swirl-right'; Path = "<path d='M146 356C88 262 120 146 220 110C318 76 424 130 454 220C480 300 438 382 360 408C292 430 216 398 188 336C164 282 186 222 236 198C284 176 352 196 418 244' fill='none' stroke='#111' stroke-width='20' stroke-linecap='round' stroke-linejoin='round'/><path d='M334 184 448 256 334 328Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/>" },
  [pscustomobject]@{ Name = 'arrow-swirl-left'; Path = "<g transform='rotate(180 256 256)'><path d='M146 356C88 262 120 146 220 110C318 76 424 130 454 220C480 300 438 382 360 408C292 430 216 398 188 336C164 282 186 222 236 198C284 176 352 196 418 244' fill='none' stroke='#111' stroke-width='20' stroke-linecap='round' stroke-linejoin='round'/><path d='M334 184 448 256 334 328Z' fill='#fff' stroke='#111' stroke-width='16' stroke-linejoin='round'/></g>" }
)
